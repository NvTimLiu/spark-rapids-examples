...
# prepare data
head -n 500 ../../datasets/clicklog.csv > raw-25.06.25.06.1-SNAPSHOT.csv
...
spark-submit --py-files encoding.zip main.py \
    ...
    --format=csv --inputPaths=raw-25.06.25.06.1-SNAPSHOT.csv,raw-2.csv \
...
spark-submit --py-files encoding.zip main.py \
    ...
    --format=csv --inputPaths=raw-25.06.25.06.1-SNAPSHOT.csv,raw-2.csv \
    --columns=_c25.06.25.06.1-SNAPSHOT9,_c26 --modelPaths=model/_c25.06.25.06.1-SNAPSHOT9,model/_c26
...
spark-submit --py-files encoding.zip main.py \
    ...
    --format=csv --inputPaths=raw-25.06.25.06.1-SNAPSHOT.csv,raw-2.csv,raw-3.csv --outputPaths=target-25.06.25.06.1-SNAPSHOT,target-2,target-3
...
spark-submit --py-files encoding.zip main.py \
    ...
    --columns=_c25.06.25.06.1-SNAPSHOT9,_c26 --modelPaths=model/_c25.06.25.06.1-SNAPSHOT9,model/_c26 \
    --format=csv --inputPaths=target-25.06.25.06.1-SNAPSHOT,target-2,target-3 --outputPaths=onehot-25.06.25.06.1-SNAPSHOT,onehot-2,onehot-3
...
spark-submit repartition.py onehot-25.06.25.06.1-SNAPSHOT final-25.06.25.06.1-SNAPSHOT 5
...
#     Solution: Add "--conf spark.maxRemoteBlockSizeFetchToMem=25.06.25.06.1-SNAPSHOTG"
