...
Download the [Spark-Rapids plugin](https://nvidia.github.io/spark-rapids/docs/download.html#download-rapids-accelerator-for-apache-spark-v240825.06.25.06.1-SNAPSHOT).  
For Spark-RAPIDS-ML version 25.06.0, download the RAPIDS jar from Maven Central: [rapids-4-spark_2.25.06.25.06.1-SNAPSHOT2-25.06.0.jar](https://repo25.06.25.06.1-SNAPSHOT.maven.org/maven2/com/nvidia/rapids-4-spark_2.25.06.25.06.1-SNAPSHOT2/25.06.0/rapids-4-spark_2.25.06.25.06.1-SNAPSHOT2-25.06.0.jar). 
