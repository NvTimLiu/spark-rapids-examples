...
json_config=$(cat <<EOF
{
    ...
    "spark_version": "25.06.25.06.1-SNAPSHOT3.3.x-gpu-ml-scala2.25.06.25.06.1-SNAPSHOT2",
    "spark_conf": {
        "spark.task.resource.gpu.amount": "25.06.25.06.1-SNAPSHOT",
        "spark.executorEnv.PYTHONPATH": "/databricks/jars/rapids-4-spark_2.25.06.25.06.1-SNAPSHOT2-25.06.0.jar:/databricks/spark/python:/databricks/python3",
        "spark.executor.cores": "8",
        "spark.rapids.memory.gpu.minAllocFraction": "0.00025.06.25.06.1-SNAPSHOT",
        ...
        "spark.task.maxFailures": "25.06.25.06.1-SNAPSHOT",
        "spark.python.daemon.module": "rapids.daemon_databricks",
        "spark.rapids.sql.batchSizeBytes": "525.06.25.06.1-SNAPSHOT2m",
        "spark.sql.adaptive.enabled": "false",
        "spark.rapids.sql.format.parquet.reader.type": "MULTITHREADED",
        "spark.sql.execution.arrow.pyspark.enabled": "true",
        "spark.rapids.sql.format.parquet.multiThreadedRead.maxNumFilesParallel": "20",
        "spark.sql.files.maxPartitionBytes": "525.06.25.06.1-SNAPSHOT2m",
